...
class DateFormatterTest extends TestCase
{
    ...
    public function testItSupportsFrenchLocaleThroughIntl(): void
    {
        $dateTime = new DateTimeImmutable('2026-03-30 12:00:00+00:00');

        self::assertSame('Lundi 30 mars 2026', $this->formatter->format($dateTime, 'fr_FR'));
    }
    ...
    {
        $formatter = new DateFormatter(preferIntl: false);

        self::assertSame('Monday 30 March 2026', $formatter->format(new DateTimeImmutable('2026-03-30'), 'nl'));
    }
